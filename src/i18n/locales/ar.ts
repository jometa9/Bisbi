...
export const ar: Translations = {
  ...
  settings: {
    ...
    transcriptionMode: {
      title: 'وضع الكتابة',
      description: 'اختر أين تتم كتابة صوتك. يبقي الوضع الخاص كل شيء على هذا الكمبيوتر.',
      offline: {
        label: 'خاص (بدون اتصال)',
        hint: 'يعمل بالكامل على هذا الكمبيوتر. صوتك لا يغادر الجهاز.',
      },
      cloud: {
        label: 'عبر الإنترنت',
        hint: 'كتابة بجودة أعلى باستخدام خوادمنا. يتطلب اتصال إنترنت. لا نخزّن الصوت ولا النص — نعالجه ونعيد لك النتيجة فقط.',
      },
    },
    transcriptionEngine: {
      title: 'محرك الكتابة',
      description: {
        offline: 'اختر كيف يوازن Bisbi بين السرعة والدقة على هذا الكمبيوتر.',
        cloud: 'اختر كيف نوازن بين السرعة والدقة في السحابة.',
      },
      fast: {
        label: 'سريع',
        hint: {
          offline:
            'نموذج أخف يعمل بسرعة على أي جهاز. دقة أقل مع اللهجات والأسماء والصوت ذي الضجيج.',
          cloud: 'مُحسَّن للسرعة. زمن استجابة أقل للمقاطع القصيرة.',
        },
      },
      accurate: {
        label: 'دقيق',
        hint: {
          offline:
            'كتابة بجودة أعلى. يُنصح به على Mac وعلى أجهزة Windows الحديثة (CPU/GPU).',
          cloud: 'أفضل جودة للهجات والأسماء والصوت المعقّد.',
        },
      },
    },
    uiLanguage: {
