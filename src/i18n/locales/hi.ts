...
export const hi: Translations = {
  ...
  settings: {
    ...
    precision: {
      ...
      fast: {
        label: 'तेज़',
        hint: 'हल्के मॉडल के साथ लगभग तुरंत ट्रांसक्रिप्शन। एक ही भाषा में स्पष्ट बोलने पर आदर्श।',
      },
      accurate: {
        label: 'सटीक (अनुशंसित)',
        hint: 'सबसे सटीक विकल्प। धीमा और भारी, लेकिन मिश्रित भाषाओं, तकनीकी शब्दों, शोर भरे ऑडियो या कई वक्ताओं के लिए बेहतर।',
      },
    },
    muteAudio: {
