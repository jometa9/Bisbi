...
export const hi: Translations = {
  app: {
    ...
    resourcesMissing:
      'Bisbi के संसाधन गायब हैं। बाइनरी और मॉडल को {path} में डाउनलोड करने के लिए README देखें।',
    micError:
  ...
  settings: {
    ...
    transcriptionLanguage: {
      ...
      description: 'Bisbi स्वतः भाषा का पता लगाता है। तेज़ी के लिए इसे फ़िक्स करें।',
    ...
    suppressNonSpeech: {
      ...
      description:
        'Bisbi "[संगीत]", "[हँसी]" या "(आह)" जैसी टिप्पणियों को ट्रांसक्राइब कर सकता है। तय करें कि वे आपके टेक्स्ट में दिखें या नहीं।',
      enabled: {
  ...
  onboarding: {
    ...
    back: 'वापस',
    welcome: {
      title: 'Bisbi में आपका स्वागत है।',
      subtitle:
    ...
    account: {
      title: 'काम कर गया, है ना?',
      subtitle:
        'सेटिंग्स सहेजने और Bisbi उपयोग शुरू करने के लिए अपना खाता बनाएँ।',
      signIn: 'Google से जारी रखें',
      microcopy: 'शुरुआत मुफ़्त। क्रेडिट कार्ड की ज़रूरत नहीं।',
    },
  },
};
