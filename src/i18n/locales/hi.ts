...
export const hi: Translations = {
  ...
  settings: {
    ...
    handsFree: {
      title: 'हैंड्स-फ्री मोड',
      description:
        'बंद होने पर रिकॉर्ड करने के लिए हॉटकी दबाए रखें (पुश-टू-टॉक)। तेज़ डबल-टैप रिकॉर्डिंग को लॉक कर देता है जब तक आप दोबारा टैप न करें।',
      label: 'शुरू करने के लिए टैप, बंद करने के लिए टैप',
      hintOn: 'चालू: शुरू करने के लिए हॉटकी एक बार टैप करें, बंद करने के लिए दोबारा टैप करें।',
      hintOff:
        'बंद: रिकॉर्ड करने के लिए हॉटकी दबाए रखें। तेज़ डबल-टैप रिकॉर्डिंग को लॉक कर देता है ताकि आप कुंजी छोड़ सकें।',
    },
